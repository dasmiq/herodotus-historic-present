...
[^18]: See Crane's "Generating and Parsing Classical Greek" ([1991](#crane91)) for more information on Morpheus. 
...
[^44]: Especially if, as McKay says ([1974](#mckay74): 247), "the 'annalistic' present, being less colorful, would, one might expect, lend itself to conjunction reduction." This argument need not be adduced, for even if we consider conjunction reduction a better explanation than vividness, we need not exclude all vivid events from the conjunction-reduced present.
